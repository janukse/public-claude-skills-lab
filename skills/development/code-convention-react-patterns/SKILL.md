...
> 포괄적인 보안 규칙(XSS 방지, 입력 검증, 환경 변수, 민감 정보 보호, 암호학적 난수 생성)은 `code-convention-security` 스킬을 참조하세요. 아래는 React 프레임워크에 특화된 보안 규칙입니다.
...
먼저 `code-convention-security verify`를 호출하여 G9 일반 보안 규칙(XSS, 입력 검증, 환경 변수, 민감 정보, 의존성, 메모리, 난수)을 검증합니다. 그 후 아래 React 고유 패턴을 추가 검증합니다.
...
| code-convention-react:G1-G3 | ... | ... | ... | ... |
| code-convention-react-patterns:G4. 스타일링 | 0 | 0 | 1 | ✅ |
| code-convention-react-patterns:G5. 성능 | 0 | 2 | 0 | ⚠️ |
| code-convention-react-patterns:G6. 파일 구조 | 0 | 0 | 0 | ✅ |
| code-convention-react-patterns:G7. 보안 | 0 | 0 | 0 | ✅ |
