...
| code-convention-quality:G6. 주석/문서화 | 0 | 1 | 0 | ⚠️ |
| code-convention-quality:G7. 테스트 | 0 | 0 | 1 | ✅ |
| code-convention-quality:G8. Git/협업 | 0 | 0 | 0 | ✅ |
...
| File | Purpose |
|------|---------|
| `code-convention/SKILL.md` | Core 코드 컨벤션 (G1-G5 규칙) |
